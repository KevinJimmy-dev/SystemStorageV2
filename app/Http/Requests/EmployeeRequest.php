...
class EmployeeRequest extends FormRequest
{
    ...
    public function messages(){
        return [
            ...
            'passwordConf.required' => 'Preencha o campo confirmando sua senha!',
            'passwordConf.min' => 'Sua senha deve conter no minimo 3 caracteres!',
            'passwordConf.max' => 'Sua senha deve conter no maximo 16 caracteres!'
        ];
    }
}
