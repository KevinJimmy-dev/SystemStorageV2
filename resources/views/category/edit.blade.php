...
@section('title', 'Editar ' . $category->name_category .  ' - Storage System')

@section('content')
    <h1 class="text-center mt-4 mb-5">Editar Categoria: {{$category->name_category}}</h1>
        ...
        <div class="container w-50 p-3">
            <form method="POST" action="{{ route('category.update', $category->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="newCategorie" required name="name_category" maxlength="75" placeholder="Digite o nome da categoria" value="{{$category->name_category}}" onkeyup="check();">
    ...
    <script>
        const categorieValue = "{{$category->name_category}}";
